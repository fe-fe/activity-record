...
Script que verifica dados da janela em foco do windows extrair palavras-chave como nome de ferramentas, tecnologias, etc, e envia esses dados automaticamente atravez da api do GitHub, permitindo alimentar dados para paginas do GitHub Pages.
